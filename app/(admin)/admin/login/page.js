    ...
    <div className="admin-auth-card">
      ...
      <form className="admin-form" onSubmit={handleSubmit}>
        ...
        <div className="admin-form-row">
          ...
          <input id="email" name="email" type="email" required defaultValue="superadmin@ptikn.com" />
        </div>
        <div className="admin-form-row">
        ...
        <div className="auth-demo">
          ...
          <ul>
            {adminCredentials.map((a) => (
              <li key={a.email}>
                <code>{a.email}</code> · <code>password</code> — {a.role === 'super_admin' ? 'Super Admin' : 'Admin'}
              </li>
            ))}
          </ul>
        </div>
